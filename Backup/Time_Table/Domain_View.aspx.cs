...
{
    public partial class Domain_View : System.Web.UI.Page
    {
        ...
        public void Bind()
        {
            try
            {
                ...
                new DatabaseConnectionManager().Get_Domain_Load(this,query,TL, TT, TP, TNT);
   ...
   contentType = "application/vnd.ms-excel";
        ...
        private void ExportFile(string fileName, string contentType)
        {
            ...
            GridView1.AllowPaging = false;
            //GridView1.FindControl("Section_Number").Visible = false;
            GridView1.Columns[1].Visible = false;
            Bind();
