<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Final_Sheet.aspx.cs" Inherits="Time_Table.Final_Sheet"
...
<body>
  ...
  <div class="round-button">
    ...
    <br />
       <center> 
           <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" 
            CssClass="myButton" ontextchanged="DropDownList1_TextChanged">
             <asp:ListItem>Uid</asp:ListItem>
            <asp:ListItem>Domain Wise</asp:ListItem>
   ...
   <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            PageSize="10" Font-Size="X-Small" onrowdatabound="GridView1_RowDataBound">
    <Columns>
...
<ItemStyle Width="150px"></ItemStyle>
         ...
         <asp:BoundField DataField="Feculty_Name" HeaderText="Feculty_Name" 
            ItemStyle-Width="150px" >
